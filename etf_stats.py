...
if __name__ == "__main__":
    ...
    if config["env"] == "qa":
        ...
        spot = Spot(
            ...
            access_key="73d0d378-a7cd-4af9-9f96-3421a3049581",
            secret_key="0b4825b80f34595669f2e03beb20225fd702f270",
        )
    ...
    while True:
        ...
        for asset in info["assets"]:
            ...
            if asset["currency"] == "stg5l":
                ...
                xt_coin_remain = (
                    -1 * xt_coin_remain
                    if float(asset["totalAmount"]) < 10000
                    else xt_coin_remain
                )
    ...
    res = order_manager.client.get_history_orders(
        symbol=config["symbol"], limit=100, start_time=timestamp_10am
    )
