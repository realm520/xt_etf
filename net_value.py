...
def get_parser():
    ...
    parser.add_argument("--rebalance", type=float, default=0.05, help="Rebalance threshold ratio.")
    parser.add_argument("--m-lever", type=int, default=5, help="Leverage multiplier.")
    parser.add_argument("--interval", type=int, default=1, help="Loop interval in seconds.")
    parser.add_argument("--long", type=str2bool, default=False, help="Operate in long mode (True/False).")
